...
export interface BlogPost {
  ...
  image: string
  category: string
  categorySlug: string  // 🆕 URL-safe slug for reliable category matching
  subcategory?: string  // 🆕 Subcategory name if exists (mirrors database parent/child relationship)
  subcategorySlug?: string  // 🆕 URL-safe slug for subcategory matching
  tags: string[]
  date: string
  readTime: string
  author: Author
  ...
  contentType?: 'custom' | 'listicle' | 'faq' | 'product-review' | 'how-to-guide' | 
